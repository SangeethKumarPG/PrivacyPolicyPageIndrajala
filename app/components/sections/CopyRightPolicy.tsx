...
function CopyRightPolicy() {
    return (
        <section id="copyright-policy" className='mb-8'>
            <h2 className='text-2xl font-semi-bold mb-4 text-gray-800'>Copyright Policy</h2>
            ...
            <h4 className="text-xl font-semi-bold p-2">Ownerships and Copyrights</h4>
            <p>
            ...
            <h4 className="text-xl font-semi-bold p-2">Protection Against Unauthorized Usages</h4>
            <p>
